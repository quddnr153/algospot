...
// Implementation of representing the node of treep

typedef int KeyType;
// store one node of treep
struct Node {
...
void solve() {
    ...
    for(int i = 0; i < N; i++) candidates = insert(candidates, new Node(i + 1));
    for(int i = N - 1; i >= 0; --i) {
...
{
    cin >> N;
    for(int i = 0; i < N; i++) scanf("%d", &shifted[i]);
    solve();
